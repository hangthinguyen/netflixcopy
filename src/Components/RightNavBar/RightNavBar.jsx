...
export default function RightNavBar({isSearchBoxShown, onClick}) {
    const [isCaretIconUp, setCaretIconUpOrDown] = useState(true);
    ...
    return (
        ...
        >
            ...
            <div
                ...
                className='drop-down-account-controller'
            >
                <img
                ...
                <FontAwesomeIcon icon={faCaretDown} className={classNames('caret-down-icon', {rotated: rotated})}/>
            </div>
